...
const VagasEmpresa = () => {
    ...
    const resetStateFilter = () => {
        ...
        setCities([]); // Limpa as cidades ao resetar o estado
        toast.info('Filtro de estado resetado.');
    };

    const resetCityFilter = () => {
        setSelectedCityFilter('');
        toast.info('Filtro de cidade resetado.');
    };

    const resetModalityFilter = () => {
        setFilters(prevFilters => ({ ...prevFilters, modality: '' }));
        toast.info('Filtro de modalidade resetado.');
    };

    const resetTypeFilter = () => {
        setFilters(prevFilters => ({ ...prevFilters, type: '' }));
        toast.info('Filtro de tipo resetado.');
    };

    const resetStatusFilter = () => {
        setFilters(prevFilters => ({ ...prevFilters, status: '' }));
        toast.info('Filtro de status resetado.');
    };

    const resetPcdFilter = () => {
        setFilters(prevFilters => ({ ...prevFilters, pcd: '' }));
        toast.info('Filtro de PCD resetado.');
    };
